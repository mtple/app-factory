...
Approved App Factory ideas for future builds. App Factory builds full useful apps first; Farcaster Mini App compatibility is a distribution layer, not a product limitation.
...
_Add future unapproved candidates here only after Matt asks for a candidate list or a build cycle needs approvals._

## Completed

_Record shipped apps here after live verification._
